...
export function IconLogo(props: ComponentProps<"svg">) {
  return (
    <svg viewBox="-1 -1 26 26" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>SolidUI</title>
      <path
...
export function IconCalendarPlus(props: ComponentProps<"svg">) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export function IconDots(props: ComponentProps<"svg">) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export function IconGitBranch(props: ComponentProps<"svg">) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export function IconMailCheck(props: ComponentProps<"svg">) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export function IconTag(props: ComponentProps<"svg">) {
  return (
    <svg
      fill="none"
      stroke="currentColor"
